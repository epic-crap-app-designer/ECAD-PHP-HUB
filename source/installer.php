<?php
    ...
    function createTables($mySQLIServer, $tabePrefix){
        ...
        $mySQLInstallString .= 'create table '.$tabePrefix.'_Sessions (ID VARCHAR(50), userID VARCHAR(50), IP VARCHAR(45), cookie VARCHAR(50), creationDate datetime, active boolean, lastSeen datetime, unusedTimeout BIGINT, timeout BIGINT); ';
        $mySQLInstallString .= 'create table '.$tabePrefix.'_ClosedSessions (ID VARCHAR(50), userID VARCHAR(50), IP VARCHAR(45), cookie VARCHAR(50), creationDate datetime, active boolean, lastSeen datetime, unusedTimeout BIGINT, timeout BIGINT, dateOfClose datetime); ';
